%-----------------------------------------------------------------------------------
%   Script: To find the known and unknown data points in a 5000 datapoint 6 class and 4 class splitup
%-----------------------------------------------------------------------------------
...
for experiment=1:length(mat)
    ...
    for classRun=1:6
        ...
        if(LimitTailSize==0)
            LimitTailSize=sum(confidence_check(limits_val(1):limits_val(2))<0.8*200);
        end
